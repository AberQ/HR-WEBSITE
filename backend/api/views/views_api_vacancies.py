    ...
    @swagger_auto_schema(
        ...
        parameters=[
            openapi.Parameter(
                "search",
                openapi.IN_QUERY,
                description="Поиск по заголовку вакансии",
...
class VacancyListByEmployerAPIView(generics.ListAPIView):
    ...
    @swagger_auto_schema(
        ...
        responses={
            ...
            404: openapi.Response(
                ...
                examples={"application/json": {"error": "Работодатель не найден."}},
            ),
        },
        manual_parameters=[
            openapi.Parameter(
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not Employer.objects.filter(id=employer_id).exists():
            return Response(
                {"error": "Работодатель не найден."}, status=status.HTTP_404_NOT_FOUND
            )
    ...
    def perform_create(self, serializer):
        ...
        if not hasattr(self.request.user, "employer"):
            raise PermissionDenied(
                "Вы не являетесь работодателем и не можете создавать вакансии."
            )
    ...
    @swagger_auto_schema(
        ...
        responses={
            ...
            status.HTTP_404_NOT_FOUND: openapi.Response(
                ...
                examples={
                    "application/json": {
                        "detail": "Вы не имеете права удалять эту вакансию."
                    }
                },
            ),
            status.HTTP_401_UNAUTHORIZED: openapi.Response(
    ...
    @swagger_auto_schema(
        ...
        responses={
            ...
            status.HTTP_400_BAD_REQUEST: openapi.Response(
                ...
                examples={
                    "application/json": {"title": ["Это поле не может быть пустым."]}
                },
            ),
            status.HTTP_401_UNAUTHORIZED: openapi.Response(
                description="Ошибка авторизации. Пользователь не авторизован.",
