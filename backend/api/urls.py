...
from api.views.views_first_website import *
...
urlpatterns = [
    ...
    path('api/tags/', RedisTagListAPIView.as_view(), name='tag_list'),
    ...
    path('api/applicant/vacancies/<int:id>/', VacancyDetailAPIView.as_view(), name='vacancy_detail'),
    path('api/employer/<int:employer_id>/vacancies/', VacancyListByEmployerAPIView.as_view(), name='employer_vacancies'),



    
    path('api/employer/vacancies/create/', VacancyCreateAPIView.as_view(), name='vacancy_create'),  # POST запросы


    path('api/employer/vacancies/<int:pk>/edit/', VacancyUpdateView.as_view(), name='vacancy_edit'),

    path('api/employer/vacancies/<int:id>/delete', VacancyDeleteAPIView.as_view(), name='vacancy_delete'),
